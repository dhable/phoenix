...
/**
 * Emits stats about the state of an API call.
 *
 * @param apiFuncName The business name of an API function.
 * @param statusCode The numeric HTTP status code that will be sent back to the client.
 * @param executionTime The total number of milliseconds required to execute the API call.
 */
exports.recordApiProcessed = function(apiFuncName, statusCode, executionTime) {
   client.increment(apiFuncName + NAME_SEPARATOR + "execution");
   client.increment(apiFuncName + NAME_SEPARATOR + statusCode);
   client.gauge(apiFuncName + NAME_SEPARATOR + "execution-time", executionTime);
};
